...
\begin{figure}[H]
    ...
    \caption{Data reduction through regional filtering: Focusing on Africa to eliminate global overplotting and reveal local correlation patterns.}    \label{fig:region}
\end{figure}
